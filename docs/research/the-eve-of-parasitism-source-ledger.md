...
| GAME-02 | *Danmaku / 余白御寮 / The Negative-Space Ward* is an original browser bullet-hell work built around reproducible runs and a negative-space visual language. | [aaajiao/Danmaku](https://github.com/aaajiao/Danmaku) | current version | High | Primary project source. Use it to identify the game’s actual mechanics, visual vocabulary, and version history. |
| GAME-03 | *1bit* is an interactive first-person 3D work in which the player moves through procedurally generated hybrid ruins while carrying a glowing flower. | [aaajiao/1bit](https://github.com/aaajiao/1bit) | current version | High | Primary project source. Use it to ground claims about Player, movement, gaze, and the flower rather than treating first-person play as a generic form. |
